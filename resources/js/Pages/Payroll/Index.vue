    ...
    <AuthenticatedLayout>
        ...
        <div v-if="showModal" class="fixed inset-0 z-50 flex items-center justify-center bg-black/70 backdrop-blur-sm p-4" @click.self="showModal = false">
            <div class="w-full max-w-lg rounded-2xl p-7 shadow-2xl" style="background: #0d1424; border: 1px solid rgba(255,255,255,0.1);">
                <h3 class="text-lg font-bold text-white mb-5">New Payroll Record</h3>
                <form @submit.prevent="submit" class="space-y-4">
                    ...
                    <div class="flex justify-end gap-3 pt-2">
                        ...
                        <button type="submit" :disabled="form.processing" class="px-5 py-2.5 text-sm font-semibold text-white rounded-xl transition" style="background: linear-gradient(135deg, #8b5cf6, #6d28d9);">Create Record</button>
                    </div>
                </form>
            </div>
        </div>
